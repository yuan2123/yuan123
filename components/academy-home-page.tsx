...
const journeyStarMarkup = (label: string) => {
  ...
  return `<svg class="spark-mark" viewBox="0 0 100 100" aria-hidden="true"><defs><radialGradient id="${gradientId}" gradientUnits="userSpaceOnUse" cx="22" cy="76" r="78"><stop class="spark-pink-accent" offset="0%" stop-color="#ffffff"/><stop class="spark-pink-soft" offset="25%" stop-color="#fffdf7"/><stop offset="48%" stop-color="#faf2de"/><stop offset="70%" stop-color="#f3e2b9"/><stop offset="87%" stop-color="#e8cf91"/><stop offset="100%" stop-color="#d9b563"/></radialGradient></defs><path d="M50 3L59.5 36.5L94.5 35.5L66 56.5L76.5 91L50 70L23.5 91L34 56.5L5.5 35.5L40.5 36.5Z" style="fill:url(#${gradientId})" stroke="#b58a3c" stroke-width="1.3" stroke-linejoin="round"/><text x="50" y="54" text-anchor="middle" dominant-baseline="middle" fill="#694819" font-size="21" font-weight="500" font-family="system-ui, sans-serif">${label}</text></svg>`;
};
